---
title: "Basal Membrane""
subtitle: |
  \raggedright  Soojin^1,2,\*^ , Stefan^1,2^, Author 3^3^, Author 4E^4^ \newline<br>^1^Heidelberg University, Centre for Organismal Studies (COS), Exeter, UK \newline<br>^2^Affiliation 2 \newline<br>^3^Affiliation 3 \newline<br>^4^Affiliation 4\newline<br>  ^\*^Correspondence: sr@cos.uni-heidelberg.de
mainfont: Arial
...
```{r, out.width = "100%", fig.cap="**Figure 1. Title fig 1** (A) hello (B) legend. " }
#| echo: false 

knitr::include_graphics("figures/Figure_DI.png")
```
